...
export const TMC_LANGS_JAR_URL =
  'http://maven.testmycode.net/nexus/content/repositories/snapshots/fi/helsinki/cs/tmc/tmc-langs-cli/0.7.7-SNAPSHOT/tmc-langs-cli-0.7.7-20171213.095142-15.jar';

export const PROJECT_FOLDER = `${homedir()}/TMCVscodeProjects`
